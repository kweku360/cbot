 ...
 */
pageNavigate.toInstantVirtuals = async (page) => {
  try {
    await page.waitForSelector('.m-nav-wrapper > .m-nav-main > #topHeader > #header_nav_instantVirtuals > span')
    await page.click('.m-nav-wrapper > .m-nav-main > #topHeader > #header_nav_instantVirtuals > span')
  } catch (e) {
