...
const selectors = [
  {
    ...
    id: "b-01",
    selector:
      ".swipe-tutorial-container > .button-wrapper > .af-button",
  },
  {
    name: "homeTeam",
    id: "b-02",
    selector: ".m-table:nth-child(1) > .event-list:nth-child(une-1) > .m-table-row > .m-table-cell > .teams-info-wrap > .teams-info:nth-child(1) > span",
  },
  {
    name: "awayTeam",
    id: "b-03",
    selector: ".m-table:nth-child(1) > .event-list:nth-child(une-1) > .m-table-row > .m-table-cell > .teams-info-wrap > .teams-info:nth-child(3) > span",
  },
  {
